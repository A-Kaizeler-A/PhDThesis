...
\\
\\
Finally, we derived an SG-associated gene signature from transcriptomic data of unstressed and stressed cells, with and without SG formation. This signature, validated in an independent dataset, revealed potential prognostic value across several human cancers, including adrenocortical carcinoma, cholangiocarcinoma, mesothelioma, and gastric adenocarcinoma, where higher SG activity correlated with poorer survival.
\\
\\
