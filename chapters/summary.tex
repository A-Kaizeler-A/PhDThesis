...
\\
\\
Finally, we derived an SG-associated gene signature from transcriptomic data of unstressed and stressed cells, with and without SG formation. This signature, validated in an independent dataset, revealed potential prognostic value across two human cancers, including adrenocortical carcinoma, and mesothelioma, where higher SG activity correlated with improved survival.
\\
\\
