...
This thesis follows a coherent narrative centred on \gls{sg} biology, interspersed with some side projects that, while not directly part of the SG project, contributed essential technical and analytical expertise that strengthen the overall research project and are therefore presented as integral components of the doctoral training process. These included the entirety of Chapters 3 and 6, as well as Chapter 7.2.
\\
\\
...
\\
\\
Chapters 3 through 9 (with the exception of chapters 3 and 6, as mentioned above) address the specific aims described above and comprise the main body of the \gls{sg}-centred research. Each chapter contains an independent Methods section detailing the experimental and computational approaches relevant and contained to that section. For \textit{in vitro} experiments, in the interest of reproducibility, reagents \glspl{rrid} and \gls{cvcl} identifiers are provided. Chapter 4 includes an in-depth analysis of a representative \gls{sg}-transcriptome dataset, serving as a methodological reference framework for subsequent analyses performed across additional datasets.
\\
\\
