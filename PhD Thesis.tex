...
\usepackage{xcolor}
\usepackage{etoolbox} % for if-odd-page detection
\usepackage{tocloft}
\newcommand{\listequationsname}{List of Equations}
\newlistof{myequations}{equ}{\listequationsname}

\newcommand{\eqcaption}[1]{%
	\addcontentsline{equ}{myequations}{Equation \theequation: #1}
}

% Custom margin comment that works on both odd and even pages
\newcommand{\comment}[1]{%
	\marginnote[%
	% left margin version for even pages
	\scriptsize\colorbox{yellow!15!white}{\parbox{1.9cm}{#1}}%
	]{%
		% right margin version for odd pages
		\scriptsize\colorbox{yellow!15!white}{\parbox{1.9cm}{#1}}%
	}[0pt]  % vertical offset, adjust if needed
}
...
% captions spanning more than one page 
...
%
    \begin{center}
        ...
        Gulbenkian Institute for Molecular Medicine (BI-70-2025)\\
        2026
    \end{center}
\end{titlepage}
...
\printglossary
\renewcommand*{\acronymname}{Abbreviations, acronyms, innitialisms, and symbols}
...
\begin{center}
	...
	\textbf{ Disclosure of AI Tool Usage:} This thesis includes the use of generative artificial intelligence tools, specifically ChatGPT (OpenAI, GPT-4 and GPT 5.5) and Claude (Anthropic, Sonnet 4.6), to assist with language editing, text refinement, brainstorming, code troubleshooting, and figure design. These tools were used under my supervision, and all generated content was critically reviewed and verified for accuracy and appropriateness. I confirm that the intellectual content, interpretation, and conclusions presented in this thesis are my own, with AI used solely as a supporting tool in accordance with institutional guidelines on academic integrity.
\end{center}
...
\input{chapters/ChapterIV_NAME}
\input{chapters/ChapterV_NAME}
\input{chapters/ChapterVI_NAME}
\input{chapters/methods}
\input{chapters/ChapterIII_NAME}
\input{chapters/discussion}

% citations using BibTeX
\bibliographystyle{plos2015_improved}
\twocolumn
{\footnotesize
\bibliography{refs}}
\onecolumn
